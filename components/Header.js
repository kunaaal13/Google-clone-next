    ...
    <header className="sticky top-0 bg-white">
      ...
      shadow-lg max-w-3xl items-center"
        >
          ...
          <XIcon
            className="sm:mr-3 h-7 text-gray-500 cursor-pointer transition-duration-100 hover:scale-125"
            onClick={() => {
              searchInputRef.current.value = '';
            }}
          />
          <MicrophoneIcon
            className="h-6 mr-6 hidden sm:inline-flex text-blue-500 border-l-2 pl-4 
        border-gray-300"
          />
          <SearchIcon
            className="h-6 mr-6 hidden sm:inline-flex text-blue-500 border-l-2 pl-4 
        ...
        <Avatar
          className="ml-auto"
          url="https://pbs.twimg.com/profile_images/1268824832424022017/vUx5TGw7_400x400.jpg"
        />
      </div>
